                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box" style="display:flex;justify-content: center;align-items: center;">
                            <a href="{{url('/dashboard')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <!-- LOGO -->
                                    <img src="{{ asset('/site_data_images') }}/{{get_logo()}}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <!-- LOGO -->
                                    <img src="{{ asset('/site_data_images') }}/{{get_logo()}}" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="{{url('/dashboard')}}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <!-- <h1>LOGO</h1> -->
                                    <img src="{{ asset('/site_data_images') }}/{{get_logo()}}" alt="" height="70" style="padding-top: 5px;">
                                </span>
                            </a>
                        </div>
